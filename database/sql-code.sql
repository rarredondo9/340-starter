...
CREATE TABLE public.classification (
    classification_id INT GENERATED BY DEFAULT AS IDENTITY classification_name CHARACTER VARYING NOT NULL,
...
-- Replace "small interiors" with "a huge interior" in GM Hummer description
...
-- Update image and thumbnail paths to include '/vehicles'
UPDATE public.inventory
